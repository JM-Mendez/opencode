export const dict = {
  ...
  "session.question.plan.view": "View plan",
  "session.question.plan.title": "Plan markdown",
  "session.question.plan.loading": "Loading plan...",
  "session.question.plan.loadFailed": "Unable to load plan markdown.",
